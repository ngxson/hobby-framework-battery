...
const getHTMLContent = () => {
  ...
  const enableCores = pCores
    ? fs.readFileSync('/sys/fs/cgroup/cpuset/active_cores/cpuset.cpus').toString().replace('-', ' to cpu')
    : 'All cores';
  return `
    <br/>
    ...
    <b>Enabled cores:</b> from cpu${enableCores}<br/>
